    ...
    return (
      <Layout className="layout">
        <Header style={{ display: 'flex', flexFlow: 'row' }}>
          <h1 style={{ color: '#fff', flex: '1' }}>图像分析 - 付费功能</h1>
        ...
        <Content style={{ padding: '0 50px' }}>
          ...
          <Card title="去噪对比图" style={{ marginTop: 24 }}>
            <img style={{ width: '550px' }} src={this.state.imageUrl} />
            <img style={{ width: '550px', marginLeft: 12 }} src={this.state.zsUrl} />
          </Card>
          <Card title="直方均衡对比图" style={{ marginTop: 24 }}>
            <img style={{ width: '550px' }} src={this.state.imageUrl} />
            <img style={{ width: '550px', marginLeft: 12 }} src={this.state.zhfxUrl} />
          </Card>
